...
void experiment (bool enableCtsRts, std::string wifiManager)
{
  ...
  OnOffHelper onOffHelper1 ("ns3::UdpSocketFactory", InetSocketAddress (Ipv4Address ("19.71.8.1"), cbrPort));
  ...
  OnOffHelper onOffHelper2 ("ns3::UdpSocketFactory", InetSocketAddress (Ipv4Address ("19.71.8.4"), cbrPort));
   ...
   */
  uint16_t  echoPort = 9;
  UdpEchoClientHelper echoClientHelper1 (Ipv4Address ("19.71.8.1"), echoPort);
  ...
  pingApps1.Add (echoClientHelper1.Install (nodes.Get (1)));
  //echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (0.006)));
  //pingApps.Add (echoClientHelper.Install (nodes.Get (2)));


  UdpEchoClientHelper echoClientHelper2 (Ipv4Address ("19.71.8.4"), echoPort);
  ...
  pingApps2.Add (echoClientHelper2.Install (nodes.Get (2)));
