...
int main (int argc, char **argv) {
  ...
  positionAlloc->Add (Vector (15.0,0.0,0.0)); //1
  positionAlloc->Add (Vector (25.0,0.0,0.0)); //2
  for (int i=2;i<6;i++){
    positionAlloc->Add (Vector (40.0,i*5.0,0.0));
  }
  positionAlloc->Add (Vector (0.0,40.0,0.0)); //7
  positionAlloc->Add (Vector (5.0,40.0,0.0)); //8
  ...
  for (int i=0;i<3;i++){
    positionAlloc2->Add (Vector (5.0*i,10.0+10.0*(i/3),0.0));
  }
  positionAlloc2->Add (Vector (40.0,30.0,0.0)); //11
  positionAlloc2->Add (Vector (20.0,20.0,0.0)); //12
  positionAlloc2->Add (Vector (10.0,30.0,0.0)); //13
